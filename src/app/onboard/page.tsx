...
const DORM_PRESETS: Record<string, HallDistances> = {
  'Unit 1': { 'Crossroads': 2, 'Cafe 3': 6, 'Foothill': 18, 'Clark Kerr': 13 },
  'Unit 2': { 'Crossroads': 4, 'Cafe 3': 9, 'Foothill': 20, 'Clark Kerr': 9 },
  'Unit 3': { 'Crossroads': 5, 'Cafe 3': 1, 'Foothill': 21, 'Clark Kerr': 20 },
  'Foothill': { 'Crossroads': 18, 'Cafe 3': 18, 'Foothill': 1, 'Clark Kerr': 21 },
  'Clark Kerr': { 'Crossroads': 13, 'Cafe 3': 20, 'Foothill': 21, 'Clark Kerr': 1 },
};
